...
def load_finetuned_model(base_model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0", adapter_path="./finetuned_model"):
    ...
    try:
        with open('./finetuned_model/training_data.jsonl', 'r') as f:
            for i, line in enumerate(f, 1):
                ...
                print(f"\nサンプル {i}:")
                print(f"Q: {data['text'].split('### Human:')[1].split('### Assistant:')[0].strip()}")
